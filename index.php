     ...
     <!-- Page content -->
        <div class="w3-content" class="newStyle">
            ...
            <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
                ...
                <p class="w3-justify"> We have gather here the information and tools you need for a smooth transition into your new home.</p>
            ...
            <div class="row" style="width: 100%; height: 27em">
                <img src="images/background.png" style="position: absolute; left:0; width: 100%; height: 27em">

                <div class="row">

                    <div class="col-sm-5" style="float:left">
                        <img src="images/Desktop.png" alt="desktop" style=" width: 65%; margin-top:9em">
                        <img src="images/phone.png" alt="mobile" style="width: 45%; margin-top:12em; margin-left:-5em">
                    </div>

                    <div class="col-sm-5" style="float:right">
                        <h2 style="color: white; text-align: center; margin: auto 0; padding-top:5em; width: 100%; font-weight: bold; opacity: 0.99;"> Perfect for plannig ahead or using on the go</h2>
                ...
                <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
                    ...
                    <div class="row" style="width: 100%; height: 40em">
                        ...
                        <div class="row">
                            ...
                            <h2 style="color:white; margin-top:3em; margin-left:2em">CONTACT</h2>
                            ...
                            <div class="w3-row w3-padding-32">
                                ...
                                <div class="col-sm-4" style="float:right; margin:3em">
                                    ...
                                    <h3 style="color: white;  margin: auto 0; font-weight: bold"> <i class="fa fa-map-marker" style="width:30px"></i> Montreal, Qc </h4>
                                        <br>


                                        <h3 style="color: white;  margin: auto 0; font-weight: bold"> <i class="fa fa-phone" style="width:30px"></i> Phone: +00 1 (514)555-5555 </h4>
                                            <br>


                                            <h3 style="color: white; margin: auto 0; font-weight: bold"><i class="fa fa-envelope" style="width:30px"> </i>Email: mail@mail.com </h4>
                                                <br>
