...
<body>
    ...
    <div id="NavBarShit" class="w3-top">
        <div class="w3-bar w3-card-2" id="navbarStyle">
            ...
            <a href="../index.php" class="w3-bar-item w3-button w3-padding-large menushit selectedMenu">HOME</a>
            <a href="newsfeed.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small menushit">FORUM</a>
            <a href="tags.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small menushit">TAGS</a>
