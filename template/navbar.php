...
<div id="navbar-container" class="w3-top">
    <nav class="w3-bar w3-card-2 navbar navbar-default" id="navbar-background">
        ...
        <ul id="menu-bar" class="row">
            <li> <a id= "barThing" class="w3-bar-item w3-button w3-padding-large w3-hide-medium w3-hide-large w3-right col-sm-1" href="javascript:void(0)" onclick="myFunction()" title="Toggle Navigation Menu"><i class="fa fa-bars"></i></a> </li>
